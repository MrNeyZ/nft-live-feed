...
const a = buildHoldersAnalysis({ ...scanFromDasItems(items), collectionAddress: 'TestCollection1111111111111111111111111111', nowIso: NOW });
...
const empty = buildHoldersAnalysis({ owners: [], missingOwnerCount: 0, totalAssets: 0, truncated: false, dasError: null, collectionAddress: 'Empty11111111111111111111111111111111111111', nowIso: NOW });
...
const trunc = buildHoldersAnalysis({ owners: ['A'.repeat(43)], missingOwnerCount: 0, totalAssets: 1, truncated: true, dasError: 'DAS 429: rate', collectionAddress: 'Trunc111111111111111111111111111111111111111', nowIso: NOW });
console.log('\nCase 3 — truncated + DAS error');

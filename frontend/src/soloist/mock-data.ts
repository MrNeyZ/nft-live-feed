...
export type Marketplace = 'me' | 'tensor' | 'orbis' | 'opensea' | 'artproof';
...
export const COLLECTIONS_DB: Collection[] = [
  { name: 'Mad Lads',                   abbr: 'ML', floor: 14.2,  supply: 10000, royalty: '0%',  trades1d: 5200,  trades1h: 34,  trades10m: 11, volume: 45400, holders: 3105, listings: 2061, color: '#c7b479', vol7d: [12,18,14,22,19,28,34], floor7d: [13.1,13.8,14.0,13.5,14.2,14.8,14.2] },
  { name: 'Claynosaurz',                abbr: 'CL', floor: 5.8,   supply: 8888,  royalty: '5%',  trades1d: 1240,  trades1h: 22,  trades10m: 6,  volume: 12800, holders: 2100, listings: 890,  color: '#43b984', vol7d: [8,10,9,11,14,12,16],   floor7d: [5.2,5.4,5.6,5.5,5.7,5.9,5.8] },
  { name: 'Tensorians',                 abbr: 'TN', floor: 0.031, supply: 10000, royalty: '0%',  trades1d: 892,   trades1h: 18,  trades10m: 4,  volume: 200,   holders: 4200, listings: 1240, color: '#7c5cf0', vol7d: [4,3,5,4,6,5,7],        floor7d: [0.028,0.029,0.031,0.030,0.032,0.031,0.031] },
  ...
  { name: 'Communi3: Mad Scientists',   abbr: 'MS', floor: 35,    supply: 4918,  royalty: '10%', trades1d: 2203,  trades1h: 171, trades10m: 49, volume: 78000, holders: 1800, listings: 1163, color: '#c7b479', vol7d: [15,20,18,24,22,28,35], floor7d: [30,32,34,33,35,34,35] },
  { name: 'P2 Farmers Genesis Series',  abbr: 'P2', floor: 2.8,   supply: 6000,  royalty: '5%',  trades1d: 578,   trades1h: 45,  trades10m: 12, volume: 1600,  holders: 1200, listings: 440,  color: '#43b984', vol7d: [10,12,14,18,22,24,30], floor7d: [2.4,2.5,2.6,2.7,2.7,2.8,2.8] },
  { name: 'Owls with Attitude',         abbr: 'OA', floor: 0.03,  supply: 3333,  royalty: '3%',  trades1d: 224,   trades1h: 20,  trades10m: 8,  volume: 31.7,  holders: 800,  listings: 210,  color: '#c7b479', vol7d: [2,3,2,4,3,5,8],        floor7d: [0.025,0.027,0.028,0.029,0.030,0.031,0.030] },
  ...
  { name: 'Minute Men',                 abbr: 'MM', floor: 0.95,  supply: 6969,  royalty: '7%',  trades1d: 10141, trades1h: 504, trades10m: 74, volume: 4507.1,holders: 2400, listings: 767,  color: '#7c5cf0', vol7d: [20,22,24,28,30,32,40], floor7d: [0.8,0.85,0.9,0.92,0.94,0.94,0.95] },
];

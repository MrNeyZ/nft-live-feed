...
export function TopNav({ active }: { active?: Page } = {}) {
  ...
  useEffect(() => {
    if (typeof window === 'undefined') return;
    const HREFS = ['/dashboard', '/multi', '/mints', '/tools', '/tools/rare-feed', '/tools/mint-analyzer', '/tools/holders', '/tools/trending', '/tools/mmm-pools', '/tools/mmm-pool-lookup', '/tools/mmm-collection-scanner', '/feed'];
        ...
        <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
            <a
              ...
              style={{ color: '#9a9ab4', fontFamily: 'inherit', textDecoration: 'none', transition: 'color 0.12s' }}

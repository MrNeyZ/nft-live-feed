        ...
        {onTogglePin && (
          <div
            ...
            style={{
              ...
              position: 'absolute', top: 0, bottom: 0, left: 'auto', right: 14,
              ...
              // mid-cell. right:14 keeps the zone's visual center where the
              // prior 200px/right:4 zone sat (R + W/2 = 104px from the cell edge)
              // after the 20px width reduction. Grows LEFT only.

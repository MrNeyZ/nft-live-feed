...
// VictoryLabs — Tools › Trending Collections (LEGACY, pre-/dashboard-merge).
// Preserved as-is (byte-for-byte from before the /dashboard merge) purely so
// it can be eyeballed side-by-side with the new merged /dashboard — to spot
// anything from this version worth porting back over. Not linked from the
// TOOLS dropdown; only reachable via the /tools index tile or this URL.

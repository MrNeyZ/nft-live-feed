...
export const TH: React.CSSProperties = {
  ...
  background: 'rgba(16,11,30,0.98)', borderBottom: '1px solid rgb(var(--vl-purple-tint) / 0.10)',
...
export function CopyKey({ value, label, color }: { value: string; label?: string; color?: string }) {
  ...
  return (
    <span onClick={copy} title={value}
      style={{ cursor: 'pointer', color: copied ? 'var(--vl-green-primary)' : (color ?? 'var(--vl-purple-tint)'), fontSize: 11, ...MONO, userSelect: 'none' }}>
